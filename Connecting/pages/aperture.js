    ...
    <div className="mb-[56px] sm:mb-0 sm:mt-[56px]">
        ...
        <div className="w-screen overflow-x-hidden ">
          ...
          <div className="flex items-center w-full mt-8 sm:mt-4 md:mt-10">
            <div className="px-2 md:px-10 lg:px-16 flex items-center flex-col
            max-w-[1300px] w-full">
              {/* PART 1 */}
              ...
              <div
              className="item-center w-full max-w-[800px] mt-8 px-4 pl-5 md:px-5"
              style={{
                minHeight: "1px",
                position: "relative",
              }}
              ...
              <div className="flex items-center justify-center w-full">
                <div className="flex w-full flex-col-reverse max-w-[1400px] pb-32
                px-2 sm:px-8">
                  <div className="active:outline-none focus:outline-none" tabIndex={0}
                  style={{
                    position: "relative",
                    width: "100%",
                    maxWidth: "100%",
...

                {
                  ...
                  <div className="px-4 text-sm text-zinc-100 w-full flex
                  items-center justify-center mt-2">
                    <div className="opacity-80 hover:opacity-100 transition-all
                    cursor-pointer group">
                      <div title="Load in editor">
                        Welcome to AI Image Generator power by 

                        <a href="https://www.theblockchaincoders.com/SourceCode">
                        <strong>@theblockchaincoders</strong>
                        </a>
                      </div>
                    </div>
                  </div>
