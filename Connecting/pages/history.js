    ...
    <div className="mb-[56px] sm:mb-0 sm:mt-[56px]">
      <div className="flex flex-col">
        ...
        items-center py-4 mt-16">
          <a href="/history" className="text-5xl sm:text-6xl
          md:text-7xl mb-8 font-logo font-bold mt-0 text-center"
          >
            History
            </a>
          ...
          <div className="flex items-center w-full max-w-[500px] px-4 pl-5 md:px-5">
            ...
            <div className="mb-8">
              <button
              type="button"
              className="w-32 sm:w-36 flex items-center text-xs justify-center
              text-center h-9 rounded-full hover:brightness-110 bg-opacity-0
              shadow-sm mt-4 bg-gradient-to-t from-indigo-900 via-indigo-900
              to-indigo-800"
              >
                Search
              </button>
               ...
               <div className="mt-3 relative px-2 md:px-7 w-full">
                  ...
                  <div className="text-center px-10 text-sm mt-4 text-zinc-400">
                    <p>
                      ...
                      <a href="/apertur" className="underline">
                      generate an image
                      </a>
                    </p>
                  </div>
