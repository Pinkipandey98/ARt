...
const index = () => {
  ...
  const CALLING_ALL_POSTS = async () => {
    try {
      ...
      console.log(allAIImages);
      const storedCokkiedVlaue = Cookies.get("token");

      if (storedCokkiedVlaue) {
  ...
  <div>
    ...
    <div className="mb-[56px] sm:mb-0 sm:mt-[56px]">
      <div className="flex flex-col">
        ...
        items-center py-4 mt-16">
          <a href="/">
          <HomeLogo/>
          </a>
          <a href="/aperture" className="cursor-pointer">
          <p className="mt-2 text-xs text-indigo-300 active:scale-95
          text-center font-medium shadow-sm hover:shadow-md 
          bg-indigo-300 bg-opacity-5 hover:bg-opacity-10 border
          border-indigo-300 border-opacity-10 hover:border-opacity-20
          transition-all rounded-md px-6 py-2">
            AI Image 10.5 is here!
          </p>
          </a>

          <div className="flex items-center w-full max-w-[600px] md:
          ml=[48px] mt-8 px-4 pl-5 md:px-5">
            <div className="w-full">
              ...
              >
                ...
                text-sm px-4 py-2.5 focus:outline-none focus:ring-1
            ...
            <div className="flex justify-center">
              ...
              type="button"
              className="ml-2 h-10 w-10 rounded-full cursor-pointer flex
              items-center justify-center bg-transparent hover:bg-zinc-900"
              >
              ...
              />
                ...
                <div className="mb-8 flex flex-col items-center">
                  <div className="flex space-x-2">
                    <button className="w-32 sm:w-36 flex items-center text-xs
                    justify-center text-center h-9 rounded-full hover:brightness-110
                    bg-opacity-0 shadow-sm mt-4 bg-gradient-to-t from-indigo-900
