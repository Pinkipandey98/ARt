  ...
  return (
    ...
    {activeModel == "AI Image Art Dall-e-v3" && (
      ...
      <div className="flex space-x-2 px-2">
        <div
        onClick={() => (
          updateState({ ...value, style:
            "vivid" }), setV3Style("vivid")
        )}
      ...
      <div className="mt-3">
        <div className="select-none opacity-50 text-xs flex items-center
        justify-start mb-1">
          <Dimensions />
          <p>Dimessions</p>
        </div>
