...
const FastSlow = () => {
  return (
    <div className="-ml-1 mt-5 flex space-x-2.5
    items-center">
      <div className="relative self-center
      bg-zinc-900 rounded-lg p-[2px] flex shadow">
      ...
      py-1 text-xs whitespace-nowrap
      focus:outline-none px-2 relative w-1/2
      disabled:cursor-not-allowed bg-zinc-700 text-white"
      disabled=""
      >
        Fast
      </button>
      ...
      opacity-50">Generation speed</div>
    </div>
