...
const PromptInput = ({
  ...
  return <div className="w-full mt-[20px] ml-0 md:ml-8
  md:max-w-[300px]">
    <div className="relative border border-zinc-700 rounded-lg
    shadow-md">
      <div className="px-5 py-4 pb-5">
        ...
        <div className="flex space-x-2 px-2">
          ...
          className={`text-xs rounded-md sm:text-sm group mt-4
            whitespace-nowrap flex-1 flex select-none
            cursor-pointer hover:brightness-100 bg-gradient-to-t
            drop-shadow items-center justify-center px-2.5 ${
        ...
        {activeModel == "AI Image Art Dall-e-v2" && (
          ...
          <div className="mt-1">
            <div className="select-none opacity-50 text-xs flex
            items-center justify-start mb-3">
              <Dimensions />
              <p>Ouentity: {rangeValue}</p>
            </div>
          </div>
          </>
        )}
