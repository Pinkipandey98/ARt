...
const SingleImage = ({ setSingleID, singleID }) => {
  ...
  return ( 
  <div className="singleImage-width fixed inset-0
  w-screen h-screen overflow-hidden px-16 py-4
  flex justify-center z-40 sm:z-50 bg-zinc-900
  bg-opacity-80"
  style={{
  ...
  >
    ...
    cursor-pointer h-12 w-12 flex items-center
    justify-center text-4xl drop-shadow"
    >
      <Close />
    </div>
    <div className="single-scroll flex flex-col
    bg-zinc-800 drop-shadow-xl overflow-hidden
    rounded-xl border border-zinc-700
    box-content">
      <div className="single-scroll flex flex-col bg-zinc-800 drop-shadow-xl
      overflow-hidden rounded-xl border border-zinc-700 box-content">
      <div className="flex flex-shrink-0
      overflow-hidden text-base px-5 flex
      flex-col h-auto"
      style={{
        height: "fit-content", 
        width: 400,
      ...
      >
        ...
        bg-opacity-50 font-light flex flex-col
        space-y-5">
          <p>
            <a className="bg-red-500 bg-opacity-0
            rounded hover:bg-opacity-40
            cursor-pointer">
              {postDetail?.prompt}
            </a>
          </p>
          ...
          <div className="flex text-xs font-light">
            ...
            <a href="/aperture" className="text-sm
            w-12 flex select-none cursor-pointer
            hover:bg-zinc-600 border
            border-zinc-600 bg-zinc-700
            items-center justify-center
            rounded-md shadow px-3"
            >
              <LinkFollow />
            </a>
          </div>
        ...
        <a href="/aperture" className="text-sm rounded-md
           sm:text-sm group mt-4
           whitespace-nowrap flex-1 flex
           select-none cursor-pointer
           hover:brightness-110 bg-gradient-to-t
           from-indigo-900 via-indigo-900
           to-indigo-800 drop-shadow
           items-center justify-center px-2.5
           py-2.5 w-fit-content active:scale-95
           transition-all"
            >
              <Magic2 />
              Open Creator
            </a>
            <a href="/history" className="text-sm rounded-md
           sm:text-sm group mt-4
           whitespace-nowrap flex-1 flex
           select-none cursor-pointer
           hover:brightness-110 bg-gradient-to-t
        ...
        <div className="md:mt-6 mt-4 opacity-80
        ml-2 grid grid-clos-2 gap-2 md:flex
        flex-wrap md:flex-col md:space-x-0
        md:space-y-1 h-auto pb-32 sm:pb-8">
          <div>
            <div className="text-xs
            opacity-50">Model</div>
            <div className="text-sm">{postDetail?.aiModel}</div>
          </div>
          <div>
            <div className="text-xs
            opacity-50">Dimensions - Quentity</div>
            <div className="text-sm">{postDetail?.quentity}</div>
          </div>
      ...
      >
        <div className="flex mx-auto mt-[20px]">
          <button className="h-full w-14 text-5xl
          ...
          <div className="relative">
            ...
            right-2 space-y-2 flex flex-col
            items-end z-30">
              <a onClick={() => AI_IMAGE_DOWNLOAD(selectedImage)}
              className="bg-zinc-900
              bg-opacity-70
              hover:bg-opacity-100
              transition-opacity flex
              items-center justify-center
              cursor-pointer text-lg h-10 w-10
              rounded-lg"
              >
                <Download />
              </a>
        ...
        items-center justify-center
        overflow-hidden w-full flex-wrap mt-4
        md:mt-[10px] md:px-2">
          {
