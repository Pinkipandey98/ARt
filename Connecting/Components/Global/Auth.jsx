...
const Auth = () => {
  ...
  return ( <>
  <div
  className="fixed insert-0 bg-zinc-900 bg-opacity-40 z-50"
  style={{
    pointerEvents: "auto",
  }}
  />
    ...
    rounded-2xl z-50 px-8 py-8 text-sm border border-zinc-700"
    style={{
      top: "50%",
    ...
    >
      <div>
        <div className="flex flex-col text-zinc-200 text-center
        items-center">
          <LoginLogo />
          ...
          >
            ...
            <button onClick={() =>
              ...
              rounded-lg shadow h-9 w-64 drop-shadow flex items-center justify-center mt-3"
              >
                Login {loader && <Loader />}
              </button>
              {error && (
